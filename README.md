...
- [CDP Node Backend Template Postman Collection](postman/temp-frps-cdp.postman_collection.json)
- [CDP Node Backend Template Postman Environment](postman/temp-frps-cdp.postman_environment.json)
...
```bash
docker build --target development --no-cache --tag temp-frps-cdp:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 temp-frps-cdp:development
```
...
```bash
docker build --no-cache --tag temp-frps-cdp .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 temp-frps-cdp
```
